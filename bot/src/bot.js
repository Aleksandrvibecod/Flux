...
У тебя наверняка есть 5 приложений: одно для трат, 
другое для калорий, третье для привычек, и ты 
всё равно ничего не отслеживаешь, потому что 
задолбался переключаться.


Вот и всё, теперь один Flux. Расходы, привычки, 
вода, сон — и бесплатный ИИ внутри, который 
помогает во всём этом разобраться.


Погнали — жми кнопку и добавь первую запись, 
